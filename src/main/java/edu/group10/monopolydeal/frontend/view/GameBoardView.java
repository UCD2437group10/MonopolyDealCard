...
/**
 * Renders reusable pieces of the main game board UI.
 */
public class GameBoardView {

    /** Renders the current player's bank cards. */
    ...
    /** Renders the current player's property groups. */
    ...
    /** Renders summary cards for all opponents. */
    ...
    /** Returns the base style used by hand card buttons. */
    ...
    /** Callback used when a property stack is clicked in the UI. */
    @FunctionalInterface
