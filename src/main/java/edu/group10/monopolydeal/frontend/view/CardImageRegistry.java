...
/**
 * Resolves card names to bundled image resources and caches loaded images.
 */
public final class CardImageRegistry {
    /** Base resource folder that contains card artwork. */
    private static final String CARD_IMG_BASE = "/images/cards/";
    /** Maps canonical card names to packaged image files. */
    ...
    /** Maps runtime aliases to canonical names used by the image table. */
    ...
    /** Caches decoded images to avoid repeated resource loading. */
    ...
    /** Builds a standard image view for one card. */
    ...
    /** Loads the image for a specific card instance. */
    ...
    /** Loads an image resource and caches it by path. */
